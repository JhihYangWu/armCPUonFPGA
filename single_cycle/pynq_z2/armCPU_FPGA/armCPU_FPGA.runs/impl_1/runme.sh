...
HD_PWD='X:/single_cycle/pynq_z2/armCPU_FPGA/armCPU_FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log armCPU_FPGA_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source armCPU_FPGA_design_wrapper.tcl -notrace
