...
HD_PWD='X:/single_cycle/pynq_z2/armCPU_FPGA/armCPU_FPGA.runs/armCPU_FPGA_design_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log armCPU_FPGA_design_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source armCPU_FPGA_design_auto_pc_0.tcl
