...
HD_PWD='X:/single_cycle/pynq_z2/armCPU_FPGA/armCPU_FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log armCPU_FPGA_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source armCPU_FPGA_design_wrapper.tcl
